...
const Element = () => {
    return (
        <div className="bg-darkBlue main-h-screen px-2 py-12">
           ...
           <div className='w-full bg-fuchsia-50 p-6 flex flex-col md:flex-row items-center pt-12 pb-10 pl-12 pr-12 justify-center'> 
                <div className='md:w-1/2 text-center md:text-left pt-5 md:pt-0 pb-10 md:pb-0'>
                    <h3 className="text-blue-600 font-semibold text-lg md:text-3xl mb-2">Become a Pro Member</h3>
                ...
                <div className='md:w-1/2 text-center md:text-left pt-10 md:pt-0 pb-10 md:pb-0'>
                    <Image src="/assets/images/two.png" alt="element" width={400} height={400} className='rounded-lg'/>
                </div>
           </div>
